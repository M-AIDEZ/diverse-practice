...
//    );
    ...
    private static final Card 所有 = new Card("所有", new GlobalBuff(5.8));
    private static final Card 供货 = new Card("供货", new OfferingBuff(0.74));
    private static final Card 在线 = new Card("在线", new PlayingStatusBuff(6, PlayingStatusEnum.ONLINE));
    private static final Card 离线 = new Card("离线", new PlayingStatusBuff(5.7, PlayingStatusEnum.OFFLINE));
    private static final Card 住宅 = new Card("住宅", new BuildingTypeBuff(10.5, BuildingTypeEnum.RESIDENTIAL));
    private static final Card 商业 = new Card("商业", new BuildingTypeBuff(11.4, BuildingTypeEnum.COMMERCIAL));
    private static final Card 工业 = new Card("工业", new BuildingTypeBuff(10.5, BuildingTypeEnum.INDUSTRIAL));
