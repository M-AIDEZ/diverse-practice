...
public class Policies {
    ...
    private static final Policy 科教兴国 = new Policy("科教兴国", new PlayingStatusBuff(2, PlayingStatusEnum.OFFLINE));
    ...
    private static final Policy 普惠金融 = new Policy("普惠金融", new BuildingTypeBuff(12, BuildingTypeEnum.COMMERCIAL));
