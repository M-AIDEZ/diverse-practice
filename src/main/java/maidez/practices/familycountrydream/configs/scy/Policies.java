...
public class Policies {
    ...
    private static final Policy 区域协调发展 = new Policy("区域协调发展", new BuildingTypeBuff(2.25, BuildingTypeEnum.RESIDENTIAL));
...
//    private static final Policy 创新驱动 = new Policy("创新驱动", new BuildingTypeBuff(6, BuildingTypeEnum.INDUSTRIAL));
    ...
    private static final Policy 家国之光 = new Policy("家国之光", new GlobalBuff(0.6));

//    private static final Policy 全面依法治国 = new Policy("全面依法治国", new PlayingStatusBuff(0.2, PlayingStatusEnum.ONLINE));

    public static final List<Policy> ALL_POLICIES = Lists.newArrayList(一带一路建设, 自由贸易区建设, 区域协调发展, 家国之光);
}
